...
.bg-image {
  /* The image used */
  background-image: url("img/song_load/bg3.jpg");
...
<div class="bg-text">
  <h1 style="font-size:50px"> ** <?php echo $_GET['album'] ?> ** </h1>
     <h1> playlist </h1>
</div>
	...
	<?php
		$temp=$_GET['album'];
		$qry="SELECT * FROM `music` WHERE `m_album`= '$temp'";
...
<?php
	...
	{
	include ('dbcon.php');
	$qry2="UPDATE `resent` SET `m_id`=$k WHERE `sl`='2'";
